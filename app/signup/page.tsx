      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 overflow-y-auto">
        <div className="w-full max-w-md py-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              {password && (
                <div className="mt-3 space-y-2">
                  <div className={`flex items-center gap-2 text-sm ${passwordChecks.length ? 'text-green-600' : 'text-dadam-gray'}`}>
                    <Check className="w-4 h-4" />
                    <span>8자 이상</span>
                  </div>
                  <div className={`flex items-center gap-2 text-sm ${passwordChecks.hasLetter ? 'text-green-600' : 'text-dadam-gray'}`}>
                    <Check className="w-4 h-4" />
                    <span>영문 포함</span>
                  </div>
                  <div className={`flex items-center gap-2 text-sm ${passwordChecks.hasNumber ? 'text-green-600' : 'text-dadam-gray'}`}>
                    <Check className="w-4 h-4" />
                    <span>숫자 포함</span>
                  </div>
                </div>
            ...
            {/* Confirm Password */}
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-dadam-charcoal mb-2">
                비밀번호 확인
              </label>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-dadam-gray" />
            ...
            <div className="space-y-3 pt-2">
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <span className="text-sm text-dadam-charcoal">
                  ...
                  <Link href="/terms" className="text-dadam-gold hover:underline">이용약관</Link> 및{' '}
                  <Link href="/privacy" className="text-dadam-gold hover:underline">개인정보처리방침</Link>에 동의합니다.
                </span>
              </label>
