...
**작성일**: 2026-01-26
**저장소**: dadamfurniture-source/dadam-cabinet
**분석 브랜치**: claude/analyze-repo-structure-gIE8e
...
**다담가구**는 AI 기반 맞춤 가구 설계 플랫폼입니다. 사용자가 공간 사진을 업로드하면 Claude Vision과 DALL-E3를 활용하여 맞춤형 가구 설계안을 자동 생성합니다.
