...
**도어** — bodyH 통일 (짧은옷/긴옷 모두 동일 높이)

| 부품 | 자재 | 두께 | 크기(W×H) | 수량 | 엣지 |
|------|------|------|----------|------|------|
| 도어 | MDF | 18T | (W/doorCount-4) × **bodyH** | doorCount | 4면 |

> 외부서랍 시: 도어 높이 = bodyH - drawerCount×300
> **규칙: 모든 모듈의 도어 높이 = bodyH (= 전체H - 좌대H - 상몰딩H)로 통일**
...
| 도어 | MDF | 18T | (W/doorCount-4) × **bodyH** | doorCount | 4면 | bodyH 통일 |
